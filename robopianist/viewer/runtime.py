...
class Runtime:
    ...
    def __init__(self, environment, policy=None) -> None:
        ...
        self._time_step: Optional[dm_env.TimeStep] = None
    ...
    def tick(self, time_elapsed, paused, muted):
        ...
        Args:
            ...
            muted: A boolean flag telling if the sound is muted.
    ...
    def get_time(self):
        ...
        return self._environment.physics.data.time
    ...
    def _step_paused(self):
        mujoco.mj_forward(
            self._environment.physics.model.ptr, self._environment.physics.data.ptr
        )
    ...
    def _step(self):
        ...
        with self._error_logger:
            ...
            self._time_step = self._environment.step(action)
