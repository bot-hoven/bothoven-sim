...
# _LEFT_HAND_POSITION = (0.375, -0.15, 0.115)
# _LEFT_HAND_QUATERNION = (-1, -1, 1, 1)
# _RIGHT_HAND_POSITION = (0.375, 0.15, 0.115)
# _RIGHT_HAND_QUATERNION = (-1, -1, 1, 1)
_LEFT_HAND_POSITION = (0.45, -0.15, 0.115)
_LEFT_HAND_QUATERNION = (-1, -1, 1, 1)
_RIGHT_HAND_POSITION = (0.45, 0.15, 0.115)
_RIGHT_HAND_QUATERNION = (-1, -1, 1, 1)

# Default position for bothoven
_BOTHOVEN_LEFT_HAND_POSITION = (0.15, -0.15, 0.03)
# _BOTHOVEN_RIGHT_HAND_POSITION = (0.15, 0.08, 0.03)
_BOTHOVEN_RIGHT_HAND_POSITION = (0.45, 0.08, 0.03)
